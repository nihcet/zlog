...
func Delete[Request any, Response any](h func(context.Context, Request) (*Response, error)) func(*gin.Context) {
	return func(c *gin.Context) {
		...
		if res == nil {
			c.JSON(http.StatusNoContent, wrappedResponse.WithDeleteSuccessResponse())
			return
		}
